      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
          <Section title="1. Date colectate">
            Colectăm doar datele necesare: nume, email, mesaj și informații despre proiect, transmise voluntar prin
            formularele site-ului sau prin email.
          </Section>

          <Section title="2. Scopul prelucrării">
            Datele sunt folosite pentru a-ți răspunde la solicitări, a transmite oferte și a livra serviciile
            contractate. Nu vindem date către terți.
          </Section>

          <Section title="3. Temei legal (GDPR)">
            Prelucrarea se face în baza consimțământului tău, a interesului legitim de a comunica cu clienții potențiali
            și a obligațiilor contractuale.
          </Section>

          <Section title="4. Stocare și securitate">
            Datele sunt stocate pe servere securizate, pe durata necesară scopului colectării sau cât prevede legea (de
            regulă maxim 5 ani).
          </Section>
          ...
          <Section title="6. Cookie-uri">
            Folosim cookie-uri strict necesare, analitice și (opțional) de marketing. Poți schimba oricând preferințele
            tale.
            <div className="mt-3">
              <button
