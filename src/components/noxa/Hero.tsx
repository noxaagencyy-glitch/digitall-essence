  ...
  return (
    <section id="top" className="relative pt-36 sm:pt-44 pb-24 sm:pb-32 overflow-clip">
      ...
      <div className="relative mx-auto max-w-6xl px-6 text-center">
        ...
        <a
          href="https://wa.me/40753826448"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-4 inline-flex items-center gap-2 rounded-full glass border border-white/10 px-5 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:border-white/20 hover:bg-white/5 transition-all animate-fade-up"
